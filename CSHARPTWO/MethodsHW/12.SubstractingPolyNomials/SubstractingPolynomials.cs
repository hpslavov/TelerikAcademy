...
namespace _12.SubstractingPolyNomials
{
    ...
    {
        //Write a method that substracts two polynomials.
        ...
        static List<int> SubstractingPolynoms(List<int> listOne, List<int> listTwo)
        {
        ...
        static void Main()
        {
            ...
            List<int> arrayTwo = new List<int> { -5, 8 ,8};
            LengthRender(arrayOne, arrayTwo);
            SubstractingPolynoms(arrayOne, arrayTwo);
